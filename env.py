...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        # Obstacle type 10 - bank2
        img_obstacle10 = Image.open("images/bank2.png")
        self.obstacle10_object = ImageTk.PhotoImage(img_obstacle10)

        # Creating obstacles themselves
        # Obstacles from 1 to 18
        self.obstacle1 = self.canvas_widget.create_image(pixels * 6, pixels * 6, anchor='nw', image=self.obstacle1_object)
        # Obstacle 2
        self.obstacle2 = self.canvas_widget.create_image(pixels * 5, pixels * 6, anchor='nw', image=self.obstacle1_object)
        # Obstacle 3
        self.obstacle3 = self.canvas_widget.create_image(pixels * 4, pixels * 7, anchor='nw', image=self.obstacle1_object)
        # Obstacle 4
        self.obstacle4 = self.canvas_widget.create_image(pixels * 8, pixels * 6, anchor='nw', image=self.obstacle2_object)
        # Obstacle 5
        self.obstacle5 = self.canvas_widget.create_image(pixels * 6, pixels * 8, anchor='nw', image=self.obstacle2_object)
        # Obstacle 6
        self.obstacle6 = self.canvas_widget.create_image(pixels * 7, pixels * 8, anchor='nw', image=self.obstacle2_object)
        # Obstacle 7
        self.obstacle7 = self.canvas_widget.create_image(pixels * 2, pixels * 3, anchor='nw', image=self.obstacle3_object)
        # Obstacle 8
        self.obstacle8 = self.canvas_widget.create_image(pixels * 3, pixels * 3, anchor='nw', image=self.obstacle3_object)
        # Obstacle 9
        self.obstacle9 = self.canvas_widget.create_image(pixels * 4, 0, anchor='nw', image=self.obstacle10_object)
        # Obstacle 10
        self.obstacle10 = self.canvas_widget.create_image(pixels * 1, pixels * 8, anchor='nw', image=self.obstacle5_object)
        # Obstacle 11
        self.obstacle11 = self.canvas_widget.create_image(0, pixels * 2, anchor='nw', image=self.obstacle7_object)
        # Obstacle 12
        self.obstacle12 = self.canvas_widget.create_image(pixels * 2, pixels * 1, anchor='nw', image=self.obstacle5_object)
        # Obstacle 13
        self.obstacle13 = self.canvas_widget.create_image(pixels * 7, pixels * 4, anchor='nw', image=self.obstacle7_object)
        # Obstacle 14
        self.obstacle14 = self.canvas_widget.create_image(pixels * 6, pixels * 4, anchor='nw', image=self.obstacle8_object)
        # Obstacle 15
        self.obstacle15 = self.canvas_widget.create_image(pixels * 1, pixels * 6, anchor='nw', image=self.obstacle9_object)
        # Obstacle 16
        self.obstacle16 = self.canvas_widget.create_image(pixels * 2, pixels * 5, anchor='nw', image=self.obstacle5_object)
        # Obstacle 17
        self.obstacle17 = self.canvas_widget.create_image(pixels * 8, pixels * 1, anchor='nw', image=self.obstacle4_object)
        # Obstacle 18
        self.obstacle18 = self.canvas_widget.create_image(pixels * 5, pixels * 2, anchor='nw', image=self.obstacle2_object)

        # Final Point
        img_flag = Image.open("images/flag.png")
        self.flag_object = ImageTk.PhotoImage(img_flag)
        self.flag = self.canvas_widget.create_image(pixels * 6, pixels * 7, anchor='nw', image=self.flag_object)
